        ...
        try {
            ...
            if (isFormValid()) {
                try {
                    ...
                    const response = await axiosInstance("/deposit", {
                      method: "PUT",
                      data: fields,
                  });
  ...
  return (
    <div className="max-w-full w-full h-screen  flex">
            ...
            <div className="w-full h-full ">
                <h1 className="text-center mt-3 mb-5 text-[25px] font-bold text-[#494646]">Deposit</h1>
                <div className="bg-[#e2dfdf] h-full pl-10 pr-10 flex justify-center items-center">
                    <form onSubmit={handleSubmit} className="w-[500px] h-[400px] border-[1px] border-[#9999ce] p-10 rounded-md">
                        ...
                        <div className='mt-10 withdrawal-ogin-grad w-full rounded-2xl cursor-pointer h-8 flex items-center justify-center'><button className="text-white" type="submit">proceed</button></div>
                    </form>
                </div>
                <ToastContainer />
            </div>
